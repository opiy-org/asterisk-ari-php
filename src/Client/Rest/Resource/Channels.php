...
final class Channels extends AbstractRestClient
{
    ...
    public function originate(
        ...
        $channel = new Channel();
        $this->responseToAriModelInstance($response, $channel);
    ...
    {
        $response = $this->sendRequest(HttpMethods::GET, "/channels/{$channelId}");
    ...
    {
        $this->sendRequest(HttpMethods::POST, "/channels/{$channelId}/answer");
    }
    ...
    {
        $this->sendRequest(HttpMethods::POST, "/channels/{$channelId}/ring");
    }
    ...
    {
        $this->sendRequest(HttpMethods::DELETE, "/channels/{$channelId}/ring");
    }
    ...
    {
        $this->sendRequest(HttpMethods::POST, "/channels/{$channelId}/hold");
    }
    ...
    {
        $this->sendRequest(HttpMethods::DELETE, "/channels/{$channelId}/hold");
    }
    ...
    {
        $this->sendRequest(HttpMethods::DELETE, "/channels/{$channelId}/moh");
    }
    ...
    {
        $this->sendRequest(HttpMethods::POST, "/channels/{$channelId}/silence");
    }
    ...
    {
        $this->sendRequest(HttpMethods::DELETE, "/channels/{$channelId}/silence");
    }
    ...
    public function getChannelVar(string $channelId, string $variable): Variable
    {
        ...
        $this->responseToAriModelInstance($response, $variableModel);
